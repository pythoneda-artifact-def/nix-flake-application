...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-artifact-nix-flake = {
      ...
      url = "github:pythoneda-artifact-def/nix-flake/0.0.82";
    };
    pythoneda-artifact-nix-flake-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-artifact-def/nix-flake-infrastructure/0.0.85";
    };
        ...
        pythoneda-artifact-nix-flake-application-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-artifact-nix-flake} ${pythoneda-artifact-nix-flake-infrastructure} ${pythoneda-shared-pythonlang-application} ${pythoneda-shared-pythonlang-banner} ${pythoneda-shared-pythonlang-domain}; do
